...
@section('title', 'Tambah Produk - DapurRoti Admin')
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('harga_diskon') is-invalid @enderror" id="harga_diskon" name="harga_diskon" value="{{ old('harga_diskon') }}">
                        @error('harga_diskon')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
